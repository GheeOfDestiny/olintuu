...
<!-- Content -->
			<main id="main-doc" class = "col-md-10 s-layout__content">
                ...
                <section class = "main-section" >
                    <header><h3>Introduction to PHP</h3></header>
                    ...
                    <br>
                    <header><h3>What Kind of Language is PHP?</h3></header>
            ...
            <!-- section 2 -->
                ...
                <section class = "main-section" >
                    ...
                    <header><h3>Characteristics of PHP</h3></header>
                    <ul>
                        <li>Simplicity</li>
                        <br>
                        <li>Efficiency</li>
            ...
            <!-- section 3 -->
            	<div id="syntax"></div>
                <section class = "main-section">
                   <header><h3>PHP Syntax Overview</h3></header>
            ...
            <!-- section 4 -->
            	<div id="comments"></div>
                <section class = "main-section">
                    <header><h3>Commenting PHP Code</h3></header>
            ...
            <!-- section 5 -->
                ...
                <section class = "main-section">
                    <header><h3>PHP is case sensitive</h3></header>
                    ...
                    <br>
                    <header><h3>PHP is whitespace insensitive </h3></header>
                    ...
                    <br>  
                    <header><h3>Statements are expressions terminated by semicolons</h3></header>
            ...
            <section class = "main-section">
                    <header><h3>How Variables Work in PHP</h3></header>
                    ...
                    <header><h3>Expressions are combinations of tokens </h3></header>
                    ...
                    <header><h3>Variables Types</h3></header>
                    ...
                    <br>
                    <header><h3>Here Document </h3></header>
            	...
            	<section class = "main-section">
                	<header><h3>Operator Types</h3></header>
            	...
            	<section class = "main-section">
            		<header><h3>Control Structures</h3></header>
            		<br>
