...
<!-- Content -->
            <main id="main-doc" class = "col-md-10 s-layout__content">
                ...
                <section class = "main-section" >
                    <header><h3>Web Concepts</h3></header>
 ...
 $version = "";<br>
                 ...
                 <div id = "forms"></div>
                <section class = "main-section" >
                    <header><h3>HTML Forms</h3></header>
                    <br>
                    ...
                    <br>
                    Try out following example by putting the source code in two separate files action.php and test.php.</p>
                    <br>
...
&lt;/html&gt;<br>
                 ...
                 <div id = "method"></div>
                <section class = "main-section" >
                    <header><h3>GET and POST Method</h3></header>
                ...
                <section class = "main-section" >
                    <header><h3>PHP File Inclusion</h3></header>
                ...
                try following two examples where file does not exist then you will get different results.</p>
                <div class = "demo-code">
                      <code>
                        &lt;html&gt;<br>
                         &lt;body&gt;<br>
                 ...
                 <div id = "inputout"></div>
                <section class = "main-section" >
                    <header><h3>PHP File and I/O</h3></header>
                    <br>
                    ...
                    <p>The PHP <b>fopen()</b> function is used to open a file. It requires two arguments stating first the file name and then mode in which to operate.
                      ...
                      <br>
                      <br>
                    So here are the steps required to read a file with PHP.</p>
                    <ul>
                   ...
                   <br>
                    ...
                    <p>A new file can be written or text can be appended to an existing file using the PHP <code style="background: #F0F0F0; border-radius: 4px; padding: 3px;">fwrite()</code> function. This function requires two arguments specifying a file pointer and the string of data that is to be written. Optionally a third integer argument can be included to specify the length of the data to write. If the third argument is included, writing would will stop after the specified length has been reached.
                      <br>
                      <br>
                    The following example creates a new text file then writes a short text heading inside it. After closing this file its existence is confirmed using <code style="background: #F0F0F0; border-radius: 4px; padding: 3px;">file_exist()</code> function which takes file name as an argument</p>
                    <div class = "demo-code">
                      <code>
                        $filename = "olintumessage.txt";<br>
                 ...
                 <div id = "cookies"></div>
                <section class = "main-section" >
                    <header><h3>PHP Cookies</h3></header> 
                    <p>
                  ...
                  <br>
                    ...
                    <p>Officially, to delete a cookie you should call <code style="background: #F0F0F0; border-radius: 4px; padding: 3px;">setcookie()</code> with the name argument only but this does not always work well, however, and should not be relied on.
                      <br><br>
                    It is safest to set the cookie with a date that has already expired</p>
                    <div class = "demo-code">
                      <code>
                      &lt;?php<br>
