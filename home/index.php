...
<body>
    ...
    <div style="overflow: auto;">
        ...
        <div>
            <div id="output"></div>
            <input type="text" id="userInput" style="width: 100%; padding: 5px;" placeholder="Enter your input here" onkeydown="handleInputKeyPress(event)">
        </div>
    </div>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            editor.setValue(`<?php echo '<?php echo "Hello, World!"; ?>'; ?>`);
        ...
        function handleInputKeyPress(event) {
         ...
         function runCode() {
            ...
            // Send the code and user input to the server for execution
            fetch('exe.php', {
                method: 'POST',
                headers: {
